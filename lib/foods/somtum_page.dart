...
void main() {
  runApp(const MaterialApp(home: SomTumPage()));
}
...
class _SomTumPageState extends State<SomTumPage> {
  ...
  void _addToCart() {
    ...
    Cart.addItem("ส้มตำ${comment.isNotEmpty ? ' ($comment)' : ''}", price, qty);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("ส้มตำ"), backgroundColor: Colors.deepOrange),
          ...
          ExpansionTile(
            ...
            children: const [
              Padding(
                padding: EdgeInsets.all(8.0),
                child: Text(
                  "1. โขลกพริกและกระเทียม\n"
                  "2. ใส่มะละกอ\n"
                  "3. ปรุงรสด้วยน้ำปลา น้ำตาล มะนาว",
                ),
              ),
            ],
          ),
