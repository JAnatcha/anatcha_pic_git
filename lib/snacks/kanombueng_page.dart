...
class KanomBuengPage extends StatefulWidget {
  const KanomBuengPage({super.key});
...
class _KanomBuengPageState extends State<KanomBuengPage> {
  ...
  final int price = 60; // ราคาต่อชิ้น
  ...
  void initState() {
    super.initState();
    const videoUrl = 'https://youtu.be/rDd9A_dN1IU';
  ...
  void _addToCart() {
    ...
    Cart.addItem("ขนมเบื้อง${comment.isNotEmpty ? ' ($comment)' : ''}", price, qty);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("ขนมเบื้อง"), backgroundColor: Colors.deepOrange),
